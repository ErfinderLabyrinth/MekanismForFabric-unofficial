...
public class ToolsRecipeProvider extends BaseRecipeProvider {
    ...
    protected void addRecipes(Consumer<FinishedRecipe> consumer) {
        registerRecipeSet(consumer, "bronze", ToolsItems.BRONZE_HELMET, ToolsItems.BRONZE_CHESTPLATE, ToolsItems.BRONZE_LEGGINGS, ToolsItems.BRONZE_BOOTS,
              ...
              ToolsItems.BRONZE_SHIELD, MekanismTags.Items.INGOTS_BRONZE, Ingredient.of(Items.STICK), MekanismItems.BRONZE_NUGGET);
        registerRecipeSet(consumer, "lapis_lazuli", ToolsItems.LAPIS_LAZULI_HELMET, ToolsItems.LAPIS_LAZULI_CHESTPLATE, ToolsItems.LAPIS_LAZULI_LEGGINGS,
              ...
              ToolsItems.LAPIS_LAZULI_HOE, ToolsItems.LAPIS_LAZULI_PAXEL, ToolsItems.LAPIS_LAZULI_SHIELD, ConventionalItemTags.LAPIS, Ingredient.of(Items.STICK), null);
        registerRecipeSet(consumer, "osmium", ToolsItems.OSMIUM_HELMET, ToolsItems.OSMIUM_CHESTPLATE, ToolsItems.OSMIUM_LEGGINGS, ToolsItems.OSMIUM_BOOTS,
              ...
              ToolsItems.OSMIUM_SHIELD, MekanismTags.Items.PROCESSED_RESOURCES.get(ResourceType.INGOT, PrimaryResource.OSMIUM), Ingredient.of(Items.STICK),
        ...
        registerRecipeSet(consumer, "refined_glowstone", ToolsItems.REFINED_GLOWSTONE_HELMET, ToolsItems.REFINED_GLOWSTONE_CHESTPLATE,
              ...
              ToolsItems.REFINED_GLOWSTONE_SHIELD, MekanismTags.Items.INGOTS_REFINED_GLOWSTONE, Ingredient.of(Items.STICK), MekanismItems.REFINED_GLOWSTONE_NUGGET);
        registerRecipeSet(consumer, "refined_obsidian", ToolsItems.REFINED_OBSIDIAN_HELMET, ToolsItems.REFINED_OBSIDIAN_CHESTPLATE,
              ...
              ToolsItems.REFINED_OBSIDIAN_SHIELD, MekanismTags.Items.INGOTS_REFINED_OBSIDIAN, Ingredient.of(Items.STICK), MekanismItems.REFINED_OBSIDIAN_NUGGET);
        registerRecipeSet(consumer, "steel", ToolsItems.STEEL_HELMET, ToolsItems.STEEL_CHESTPLATE, ToolsItems.STEEL_LEGGINGS, ToolsItems.STEEL_BOOTS,
              ...
              ToolsItems.STEEL_SHIELD, MekanismTags.Items.INGOTS_STEEL, Ingredient.of(ConventionalItemTags.IRON_INGOTS), MekanismItems.STEEL_NUGGET);
    ...
    private void registerRecipeSet(Consumer<FinishedRecipe> consumer, String name, IItemProvider helmet, IItemProvider chestplate, IItemProvider leggings,
          ...
          IItemProvider shield, TagKey<Item> ingot, Ingredient rod, @Nullable IItemProvider nugget) {
        ...
        PaxelShapedRecipeBuilder.shapedRecipe(paxel)
              .pattern(PAXEL)
              .key(AXE_CHAR, TagKey.create(Registries.ITEM, new ResourceLocation("c", name + "_axes")))
              .key(PICKAXE_CHAR, TagKey.create(Registries.ITEM, new ResourceLocation("forge", "tools/pickaxes/" + name)))
              .key(SHOVEL_CHAR, TagKey.create(Registries.ITEM, new ResourceLocation("forge", "tools/shovels/" + name)))
              .key(ROD_CHAR, rod)
    ...
    private ExtendedShapedRecipeBuilder tool(RecipePattern pattern, IItemProvider tool, TagKey<Item> ingot, Ingredient rod) {
