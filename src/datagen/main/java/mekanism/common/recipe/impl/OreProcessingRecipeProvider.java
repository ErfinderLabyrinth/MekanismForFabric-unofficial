...
class OreProcessingRecipeProvider implements ISubRecipeProvider {
    ...
    public void addRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        CombinerRecipeBuilder.combining(
              IngredientCreatorAccess.item().from(ConventionalItemTags.RAW_GOLD_ORES, 8),
        ...
        addOreProcessingGemRecipes(consumer, basePath + "diamond/", Blocks.DIAMOND_ORE, Blocks.DEEPSLATE_DIAMOND_ORE, ItemTags.DIAMOND_ORES,
              MekanismItems.DIAMOND_DUST, MekanismTags.Items.DUSTS_DIAMOND, Items.DIAMOND, ConventionalItemTags.DIAMONDS, 2, 5, IngredientCreatorAccess.item().from(MekanismTags.Items.NORMAL_COBBLESTONES));
        addOreProcessingGemRecipes(consumer, basePath + "emerald/", Blocks.EMERALD_ORE, Blocks.DEEPSLATE_EMERALD_ORE, ItemTags.EMERALD_ORES,
              MekanismItems.EMERALD_DUST, MekanismTags.Items.DUSTS_EMERALD, Items.EMERALD, ConventionalItemTags.EMERALDS, 2, 5, IngredientCreatorAccess.item().from(MekanismTags.Items.NORMAL_COBBLESTONES));
        addOreProcessingGemRecipes(consumer, basePath + "lapis_lazuli/", Blocks.LAPIS_ORE, Blocks.DEEPSLATE_LAPIS_ORE, ItemTags.LAPIS_ORES,
              MekanismItems.LAPIS_LAZULI_DUST, MekanismTags.Items.DUSTS_LAPIS, Items.LAPIS_LAZULI, ConventionalItemTags.LAPIS, 12, 27, IngredientCreatorAccess.item().from(MekanismTags.Items.NORMAL_COBBLESTONES));
        addOreProcessingGemRecipes(consumer, basePath + "quartz/", Blocks.NETHER_QUARTZ_ORE, null, ConventionalItemTags.QUARTZ_ORES, MekanismItems.QUARTZ_DUST,
              MekanismTags.Items.DUSTS_QUARTZ, Items.QUARTZ, ConventionalItemTags.QUARTZ, 6, 14, IngredientCreatorAccess.item().from(Blocks.NETHERRACK));
        ...
        if (resource.isVanilla()) {
            ...
            switch (resource) {
                case IRON -> {
                    ...
                    ingotTag = ConventionalItemTags.IRON_INGOTS;
                    raw = Items.RAW_IRON;
                    rawTag = ConventionalItemTags.RAW_IRON_ORES;
                    rawBlock = Items.RAW_IRON_BLOCK;
                    rawBlockTag = ConventionalItemTags.RAW_IRON_BLOCKS;
                    ore = Blocks.IRON_ORE;
                ...
                case GOLD -> {
                    ...
                    ingotTag = ConventionalItemTags.GOLD_INGOTS;
                    raw = Items.RAW_GOLD;
                    rawTag = ConventionalItemTags.RAW_GOLD_ORES;
                    rawBlock = Items.RAW_GOLD_BLOCK;
                    rawBlockTag = ConventionalItemTags.RAW_GOLD_BLOCKS;
                    ore = Blocks.GOLD_ORE;
                ...
                case COPPER -> {
                    ...
                    ingotTag = ConventionalItemTags.COPPER_INGOTS;
                    raw = Items.RAW_COPPER;
                    rawTag = ConventionalItemTags.RAW_COPPER_ORES;
                    rawBlock = Items.RAW_COPPER_BLOCK;
                    rawBlockTag = ConventionalItemTags.RAW_COPPER_BLOCKS;
    ...
    private void addCoalOreProcessingRecipes(Consumer<FinishedRecipe> consumer, String basePath) {
        ...
        //from ore
        ItemStackToItemStackRecipeBuilder.enriching(
              IngredientCreatorAccess.item().from(ItemTags.COAL_ORES),
    ...
    private void addNetheriteProcessingRecipes(Consumer<FinishedRecipe> consumer, String basePath) {
        ...
        ItemStackToItemStackRecipeBuilder.crushing(
              IngredientCreatorAccess.item().from(MekanismTags.Items.ANCIENT_DEBRIS),
        ...
        ItemStackToItemStackRecipeBuilder.crushing(
              IngredientCreatorAccess.item().from(ConventionalItemTags.NETHERITE_INGOTS),
              MekanismItems.NETHERITE_DUST.getItemStack()
    ...
    private void addBronzeProcessingRecipes(Consumer<FinishedRecipe> consumer, String basePath) {
        ...
        //from infusing
        ItemStackChemicalToItemStackRecipeBuilder.metallurgicInfusing(
              IngredientCreatorAccess.item().from(ConventionalItemTags.COPPER_INGOTS, 3),
              IngredientCreatorAccess.infusion().from(MekanismTags.InfuseTypes.TIN, 10),
    ...
    private void addRedstoneProcessingRecipes(Consumer<FinishedRecipe> consumer, String basePath) {
        ...
        ItemStackIngredient forOre = IngredientCreatorAccess.item().from(ConventionalItemTags.REDSTONE_DUSTS, 16);
        //to ore
        CombinerRecipeBuilder.combining(
              forOre,
              IngredientCreatorAccess.item().from(MekanismTags.Items.NORMAL_COBBLESTONES),
    ...
    private void addRefinedGlowstoneProcessingRecipes(Consumer<FinishedRecipe> consumer, String basePath) {
        ...
        ItemStackChemicalToItemStackRecipeBuilder.compressing(
              IngredientCreatorAccess.item().from(MekanismTags.Items.GLOWSTONE_DUSTS),
