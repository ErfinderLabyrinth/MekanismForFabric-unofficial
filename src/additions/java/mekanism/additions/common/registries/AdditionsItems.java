...
public class AdditionsItems {
    ...
    public static final ItemRegistryObject<ItemWalkieTalkie> WALKIE_TALKIE = ITEMS.register(MekanismAdditions.rl("walkie_talkie"), ItemWalkieTalkie::new);

    public static final Map<EnumColor, ItemRegistryObject<ItemBalloon>> BALLOONS = new EnumMap<>(EnumColor.class);

    static {
        for (EnumColor color : EnumUtils.COLORS) {
            BALLOONS.put(color, ITEMS.register(MekanismAdditions.rl(color.getRegistryPrefix() + "_balloon"), () -> new ItemBalloon(color)));
        }
    }
