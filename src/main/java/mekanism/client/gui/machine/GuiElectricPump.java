...
public class GuiElectricPump extends GuiMekanismTile<TileEntityElectricPump, MekanismTileContainer<TileEntityElectricPump>> {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiInnerScreen(this, 54, 23, 80, 41, () -> {
            ...
            if (fluidStack.isEmpty()) {
                ...
                if (fallBack.isEmpty()) {
                    ...
                    list.add(Component.literal("COMING SOON (GuiElectricPump)"));
                }
            } else {
        ...
        addRenderableWidget(new GuiFluidGauge(() -> tile.fluidTank, () -> tile.getFluidManager().getHolder(), GaugeType.STANDARD, this, 6, 13))
