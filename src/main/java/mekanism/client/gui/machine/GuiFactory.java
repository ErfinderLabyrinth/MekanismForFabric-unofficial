    ...
    protected void addGuiElements() {
        ...
        if (tile.hasSecondaryResourceBar()) {
            ...
            if (tile instanceof TileEntityMetallurgicInfuserFactory factory) {
                secondaryBar = addRenderableWidget(new GuiChemicalBar<>(this, GuiChemicalBar.getProvider(factory.getInfusionTank(), tile.getInfusionManager().getHolder()),
                ...
                secondaryBar = addRenderableWidget(new GuiChemicalBar<>(this, GuiChemicalBar.getProvider(factory.getGasTank(), tile.getGasManager().getHolder()),
                      7, 76, tile.tier == FactoryTier.ULTIMATE ? 172 : 138, 4, true));
                addRenderableWidget(new GuiDumpButton<>(this, factory, tile.tier == FactoryTier.ULTIMATE ? 182 : 148, 76));
            }
