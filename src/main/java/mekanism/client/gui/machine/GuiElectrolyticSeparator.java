...
public class GuiElectrolyticSeparator extends GuiConfigurableTile<TileEntityElectrolyticSeparator, MekanismTileContainer<TileEntityElectrolyticSeparator>> {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiFluidGauge(() -> tile.fluidTank, () -> tile.getFluidManager().getHolder(), GaugeType.STANDARD, this, 5, 10))
              .warning(WarningType.NO_MATCHING_RECIPE, tile.getWarningCheck(RecipeError.NOT_ENOUGH_INPUT));
        addRenderableWidget(new GuiGasGauge(() -> tile.leftTank, () -> tile.getGasManager().getHolder(), GaugeType.SMALL, this, 58, 18))
        ...
        addRenderableWidget(new GuiGasGauge(() -> tile.rightTank, () -> tile.getGasManager().getHolder(), GaugeType.SMALL, this, 100, 18))
