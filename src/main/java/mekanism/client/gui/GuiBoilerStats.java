...
public class GuiBoilerStats extends GuiMekanismTile<TileEntityBoilerCasing, EmptyTileContainer<TileEntityBoilerCasing>> {
    ...
    protected void addGuiElements() {
        ...
        maxGraph.enableFixedScale(MathUtils.clampToLong((MekanismConfig.COMMON.general.superheatingHeatTransfer * tile.getMultiblock().superheatingElements) / HeatUtils.getWaterThermalEnthalpy()));
    }
