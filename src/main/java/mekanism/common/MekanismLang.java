...
public enum MekanismLang implements ILangEntry {
    ...
    TAG_FILTER("filter", "tag_supplier"),
    TAG_FILTER_NO_TAG("filter", "tag_supplier.no_key"),
    TAG_FILTER_SAME_TAG("filter", "tag_supplier.same_key"),
    TAG_FILTER_TAG("filter", "tag_supplier.key"),
