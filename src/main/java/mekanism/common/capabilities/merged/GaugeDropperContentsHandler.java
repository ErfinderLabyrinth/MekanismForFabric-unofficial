...
//public class GaugeDropperContentsHandler extends MergedTankContentsHandler<MergedTank> implements IMekanismFluidHandler, Storage<FluidVariant> {
//
//    private static final int CAPACITY = 16 * 81000;
...
//                    ChemicalTankBuilder.GAS.alwaysTrue, null, gasHandler = new DynamicGasHandler(side -> getGasStorage(gasTanks), InteractPredicate.ALWAYS_TRUE,
