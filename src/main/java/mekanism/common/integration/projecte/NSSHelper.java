...
//            return NSSGas.createTag(getResourceLocation(gasName.substring(1), "gas tagSupplier"));
//        }
...
//            return NSSInfuseType.createTag(getResourceLocation(infuseTypeName.substring(1), "infuse type tagSupplier"));
//        }
...
//            return NSSPigment.createTag(getResourceLocation(pigmentName.substring(1), "pigment tagSupplier"));
//        }
...
//            return NSSSlurry.createTag(getResourceLocation(slurryName.substring(1), "slurry tagSupplier"));
//        }
