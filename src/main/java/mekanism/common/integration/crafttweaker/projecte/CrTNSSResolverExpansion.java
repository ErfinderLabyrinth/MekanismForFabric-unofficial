...
//     *
//     * @param tagSupplier Gas Tag to represent
//     *
//     * @return A {@link NormalizedSimpleStack} representing a given {@link KnownTag<Gas>}.
//     */
//    @ZenCodeType.StaticExpansionMethod
//    public static NormalizedSimpleStack fromGasTag(KnownTag<Gas> tagSupplier) {
//        return NSSGas.createTag(CrTUtils.validateTagAndGet(tagSupplier));
//    }
//
//    /**
...
//     *
//     * @param tagSupplier Infuse Type Tag to represent
//     *
//     * @return A {@link NormalizedSimpleStack} representing a given {@link KnownTag<InfuseType>}.
//     */
//    @ZenCodeType.StaticExpansionMethod
//    public static NormalizedSimpleStack fromInfuseTypeTag(KnownTag<InfuseType> tagSupplier) {
//        return NSSInfuseType.createTag(CrTUtils.validateTagAndGet(tagSupplier));
//    }
//
//    /**
...
//     *
//     * @param tagSupplier Pigment Tag to represent
//     *
//     * @return A {@link NormalizedSimpleStack} representing a given {@link KnownTag<Pigment>}.
//     */
//    @ZenCodeType.StaticExpansionMethod
//    public static NormalizedSimpleStack fromPigmentTag(KnownTag<Pigment> tagSupplier) {
//        return NSSPigment.createTag(CrTUtils.validateTagAndGet(tagSupplier));
//    }
//
//    /**
...
//     *
//     * @param tagSupplier Slurry Tag to represent
//     *
//     * @return A {@link NormalizedSimpleStack} representing a given {@link KnownTag<Slurry>}.
//     */
//    @ZenCodeType.StaticExpansionMethod
//    public static NormalizedSimpleStack fromSlurryTag(KnownTag<Slurry> tagSupplier) {
//        return NSSSlurry.createTag(CrTUtils.validateTagAndGet(tagSupplier));
//    }
//
