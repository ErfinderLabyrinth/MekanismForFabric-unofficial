...
//     *
//     * @implNote We add the tagSupplier by its internal id instead of getting the internal tagSupplier as the internal tagSupplier would currently be {@code null} when this gets called, as the
