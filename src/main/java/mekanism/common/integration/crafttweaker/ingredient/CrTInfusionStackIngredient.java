...
//
//    /**
//     * Creates a {@link InfusionStackIngredient} that matches a given infuse type tagSupplier with a given amount.
//     *
//     * @param infuseTypeTag Tag to match
//     * @param amount        Amount needed
//     *
//     * @return A {@link InfusionStackIngredient} that matches a given infuse type tagSupplier with a given amount.
//     */
//    @ZenCodeType.StaticExpansionMethod
//    public static InfusionStackIngredient from(KnownTag<InfuseType> infuseTypeTag, long amount) {
//        TagKey<InfuseType> tagSupplier = CrTIngredientHelper.assertValidAndGet(infuseTypeTag, amount, "InfusionStackIngredients");
//        return IngredientCreatorAccess.infusion().from(tagSupplier, amount);
//    }
//
//    /**
//     * Creates a {@link InfusionStackIngredient} that matches a given infuse type tagSupplier with amount.
//     *
//     * @param infuseTypeTag Tag and amount to match
//     *
//     * @return A {@link InfusionStackIngredient} that matches a given infuse type tagSupplier with amount.
//     */
//    @ZenCodeType.StaticExpansionMethod
