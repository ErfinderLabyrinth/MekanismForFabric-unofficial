...
//
//    /**
//     * Validates that the amount is greater than zero and that the tagSupplier exists. If it does it get and returns the tagSupplier, otherwise it throws an error.
//     */
