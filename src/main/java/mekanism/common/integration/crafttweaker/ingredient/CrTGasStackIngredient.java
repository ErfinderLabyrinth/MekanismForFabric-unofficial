...
//
//    /**
//     * Creates a {@link GasStackIngredient} that matches a given gas tagSupplier with a given amount.
//     *
//     * @param gasTag Tag to match
//     * @param amount Amount needed
//     *
//     * @return A {@link GasStackIngredient} that matches a given gas tagSupplier with a given amount.
//     */
//    @ZenCodeType.StaticExpansionMethod
//    public static GasStackIngredient from(KnownTag<Gas> gasTag, long amount) {
//        TagKey<Gas> tagSupplier = CrTIngredientHelper.assertValidAndGet(gasTag, amount, "GasStackIngredients");
//        return IngredientCreatorAccess.gas().from(tagSupplier, amount);
//    }
//
//    /**
//     * Creates a {@link GasStackIngredient} that matches a given gas tagSupplier with amount.
//     *
//     * @param gasTag Tag and amount to match
//     *
//     * @return A {@link GasStackIngredient} that matches a given gas tagSupplier with amount.
//     */
//    @ZenCodeType.StaticExpansionMethod
