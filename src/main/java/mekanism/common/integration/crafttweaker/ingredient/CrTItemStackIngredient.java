...
//
//    /**
//     * Creates a {@link ItemStackIngredient} that matches a given item tagSupplier with a given amount.
//     *
//     * @param itemTag Tag to match
//     * @param amount  Amount needed
//     *
//     * @return A {@link ItemStackIngredient} that matches a given item tagSupplier with a given amount.
//     */
//    @ZenCodeType.StaticExpansionMethod
//    public static ItemStackIngredient from(KnownTag<Item> itemTag, int amount) {
//        TagKey<Item> tagSupplier = CrTIngredientHelper.assertValidAndGet(itemTag, amount, "ItemStackIngredients");
//        return IngredientCreatorAccess.item().from(tagSupplier, amount);
//    }
//
//    /**
//     * Creates a {@link ItemStackIngredient} that matches a given item tagSupplier with an amount of one.
//     *
//     * @param itemTag Tag to match
//     *
//     * @return A {@link ItemStackIngredient} that matches a given item tagSupplier with an amount of one.
//     */
//    @ZenCodeType.StaticExpansionMethod
...
//
//    /**
//     * Creates a {@link ItemStackIngredient} that matches a given item tagSupplier with amount.
//     *
//     * @param itemTag Tag and amount to match
//     *
//     * @return A {@link ItemStackIngredient} that matches a given item tagSupplier with amount.
//     */
//    @ZenCodeType.StaticExpansionMethod
