...
//
//    /**
//     * Creates a {@link FluidStackIngredient} that matches a given fluid tagSupplier with a given amount.
//     *
//     * @param fluidTag Tag to match
//     * @param amount   Amount needed
//     *
//     * @return A {@link FluidStackIngredient} that matches a given fluid tagSupplier with a given amount.
//     */
//    @ZenCodeType.StaticExpansionMethod
//    public static FluidStackIngredient from(KnownTag<Fluid> fluidTag, int amount) {
//        TagKey<Fluid> tagSupplier = CrTIngredientHelper.assertValidAndGet(fluidTag, amount, "FluidStackIngredients");
//        return IngredientCreatorAccess.fluid().from(tagSupplier, amount);
//    }
//
//    /**
//     * Creates a {@link FluidStackIngredient} that matches a given fluid tagSupplier with amount.
//     *
//     * @param fluidTag Tag and amount to match
//     *
//     * @return A {@link FluidStackIngredient} that matches a given fluid tagSupplier with amount.
//     */
//    @ZenCodeType.StaticExpansionMethod
