...
//
//    /**
//     * Creates a {@link PigmentStackIngredient} that matches a given pigment tagSupplier with a given amount.
//     *
//     * @param pigmentTag Tag to match
//     * @param amount     Amount needed
//     *
//     * @return A {@link PigmentStackIngredient} that matches a given pigment tagSupplier with a given amount.
//     */
//    @ZenCodeType.StaticExpansionMethod
//    public static PigmentStackIngredient from(KnownTag<Pigment> pigmentTag, long amount) {
//        TagKey<Pigment> tagSupplier = CrTIngredientHelper.assertValidAndGet(pigmentTag, amount, "PigmentStackIngredients");
//        return IngredientCreatorAccess.pigment().from(tagSupplier, amount);
//    }
//
//    /**
//     * Creates a {@link PigmentStackIngredient} that matches a given pigment tagSupplier with amount.
//     *
//     * @param pigmentTag Tag and amount to match
//     *
//     * @return A {@link PigmentStackIngredient} that matches a given pigment tagSupplier with amount.
//     */
//    @ZenCodeType.StaticExpansionMethod
