...
//
//    /**
//     * Creates a {@link SlurryStackIngredient} that matches a given slurry tagSupplier with a given amount.
//     *
//     * @param slurryTag Tag to match
//     * @param amount    Amount needed
//     *
//     * @return A {@link SlurryStackIngredient} that matches a given slurry tagSupplier with a given amount.
//     */
//    @ZenCodeType.StaticExpansionMethod
//    public static SlurryStackIngredient from(KnownTag<Slurry> slurryTag, long amount) {
//        TagKey<Slurry> tagSupplier = CrTIngredientHelper.assertValidAndGet(slurryTag, amount, "SlurryStackIngredients");
//        return IngredientCreatorAccess.slurry().from(tagSupplier, amount);
//    }
//
//    /**
//     * Creates a {@link SlurryStackIngredient} that matches a given slurry tagSupplier with amount.
//     *
//     * @param slurryTag Tag and amount to match
//     *
//     * @return A {@link SlurryStackIngredient} that matches a given slurry tagSupplier with amount.
//     */
//    @ZenCodeType.StaticExpansionMethod
