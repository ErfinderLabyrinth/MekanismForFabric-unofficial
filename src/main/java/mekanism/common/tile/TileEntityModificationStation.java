...
public class TileEntityModificationStation extends TileEntityMekanism implements IBoundingBlock, IConfigCardAccess {
                ...
                if (IModuleHelper.INSTANCE.getSupported(stack).contains(data)) {
                    ...
                    if (module == null || module.getInstalledCount() < data.getMaxStackSize()) {
                        ...
                        try(Transaction t=Transaction.openOuter()) {
                            clientEnergyUsed = energyContainer.extract(energyContainer.getEnergyPerTick(), t);
                            t.commit();
                        }
                        if (operatingTicks == ticksRequired) {
                            ...
                            MekanismUtils.logMismatchedStackSize(moduleSlot.shrinkStack(1), 1);
                        }
                    }
                }
            }
