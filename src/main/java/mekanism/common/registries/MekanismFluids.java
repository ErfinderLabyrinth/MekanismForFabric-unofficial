...
import mekanism.common.registration.impl.FluidDeferredRegister.MekanismFluid.Flowing;
import mekanism.common.registration.impl.FluidDeferredRegister.MekanismFluid.Source;
...
public class MekanismFluids {
    ...
    public static final FluidRegistryObject<Source, Flowing, LiquidBlock, BucketItem> BRINE = FLUIDS.register("brine", properties -> properties.tint(0xFFFEEF9C));
    ...
    public static final FluidRegistryObject<Source, Flowing, LiquidBlock, BucketItem> STEAM = FLUIDS.register("steam", properties -> properties.temperature(373).density(0),
