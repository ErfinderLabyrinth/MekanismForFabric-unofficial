...
//                //If the annotation data has tags add them, and otherwise fallback to the default tagSupplier
//                for (String tagSupplier : getAnnotationValue(data, "tags", fallbackTagsList)) {
//                    propertyInfo.add(new PropertyFieldInfo(fullPath, tagSupplier, newField));
//                }
//            }
//        }
...
//            classPropertyInfo.infoList().sort(Comparator.comparing(info -> info.fieldPath + "|" + info.tagSupplier));
//            for (PropertyFieldInfo field : classPropertyInfo.infoList()) {
//                cache.propertyFieldMap.put(field.tagSupplier, field.field);
//            }
...
//    }
//
//    public void setup(MekanismContainer container, Class<?> holderClass, Supplier<Object> holderSupplier, String tagSupplier) {
...
//        for (PropertyField field : cache.propertyFieldMap.get(tagSupplier)) {
...
//    }
//
//    private record PropertyFieldInfo(String fieldPath, String tagSupplier, PropertyField field) {
//    }
//}