...
public class StorageConfig extends BaseMekanismConfig {
    ...
    public long precisionSawmill;
    public long chemicalDissolutionChamber;
    public long chemicalWasher;
    public long chemicalCrystallizer;
    public long seismicVibrator;
    public long pressurizedReactionBase;
    public long fluidicPlenisher;
    public long laser;
    public long laserAmplifier;
    public long laserTractorBeam;
    public long formulaicAssemblicator;
    public long teleporter;
    public long modificationStation;
    public long isotopicCentrifuge;
    public long nutritionalLiquifier;
    public long antiprotonicNucleosynthesizer;
    public long pigmentExtractor;
    public long pigmentMixer;
    public long paintingMachine;
    public long spsPort;
    public long dimensionalStabilizer;
