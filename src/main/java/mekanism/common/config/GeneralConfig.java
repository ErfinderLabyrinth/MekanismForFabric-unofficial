...
//        validOredictionificatorFilters = CachedOredictionificatorConfigValue.define(this, builder.comment("The list of valid tagSupplier prefixes for the Oredictionificator. Note: It is highly recommended to only include well known/defined tagSupplier prefixes otherwise it is very easy to potentially add in accidental conversions of things that are not actually equivalent."),
