...
*/
    ...
    public int disassemblerMiningCount = 128;
    public boolean disassemblerSlowMode = true;
    public boolean disassemblerFastMode = true;
    public boolean disassemblerVeinMining = false;
    public int disassemblerMinDamage = 4;
    public int disassemblerMaxDamage = 20;
    public double disassemblerAttackSpeed = -2.4;
    public long disassemblerMaxEnergy = 1_000_000;
    public long disassemblerChargeRate = 5_000;
    //Configurator
    public long configuratorMaxEnergy = 60_000;
    public long configuratorChargeRate = 300;
    public long configuratorEnergyPerConfigure = 400;
    public long configuratorEnergyPerItem = 8;
    //Electric Bow
    public long electricBowMaxEnergy = 120_000;
    public long electricBowChargeRate = 600;
    public long electricBowEnergyUsage = 120;
    public long electricBowEnergyUsageFire = 1_200;
    //Energy Tablet
    ...
    public float freeRunnerFallDamageRatio = 1F;
    public long freeRunnerMaxEnergy = 64_000;
    public long freeRunnerChargeRate = 320;
    //Armored Free Runner
    public int armoredFreeRunnerArmor = 3;
    ...
    public float armoredJetpackKnockbackResistance = 0F;
    //Portable Teleporter
    public long portableTeleporterMaxEnergy = 1_000_000;
    public long portableTeleporterChargeRate = 5_000;
    public int portableTeleporterDelay = 0;
    //Network Reader
    public long networkReaderMaxEnergy = 60_000;
    ...
    public long mekaToolEnergyUsage = 10;
    public long mekaToolEnergyUsageSilk = 100;
    public int mekaToolMaxTeleportReach = 100;
    public int mekaToolBaseDamage = 4;
    public double mekaToolAttackSpeed = -2.4;
    public float mekaToolBaseEfficiency = 4;
    public long mekaToolBaseEnergyCapacity = 16_000_000;
    public long mekaToolBaseChargeRate = 100_000;
    public long mekaToolEnergyUsageHoe = 10;
    public long mekaToolEnergyUsageShovel = 10;
    public long mekaToolEnergyUsageAxe = 10;
    public long mekaToolEnergyUsageShearEntity = 10;
    public boolean mekaToolExtendedMining = true;
    //MekaSuit
    public long mekaSuitBaseEnergyCapacity = 16_000_000;
    public long mekaSuitBaseChargeRate = 100_000;
    public long mekaSuitBaseJumpEnergyUsage = 1_000;
    public long mekaSuitElytraEnergyUsage = 32_000;
    public long mekaSuitEnergyUsagePotionTick = 40_000;
    public long mekaSuitEnergyUsageMagicReduce = 1_000;
    public long mekaSuitEnergyUsageFall = 50;
    public long mekaSuitEnergyUsageSprintBoost = 100;
...
//                    "Values may be in the range [0.0, 1.0].", "See the #mekainsm:mekasuit_always_supported damage type tagSupplier for allowing damage that bypasses armor to be blocked."),
