...
public class GuiWindGenerator extends GuiMekanismTile<TileEntityWindGenerator, MekanismTileContainer<TileEntityWindGenerator>> {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiInnerScreen(this, 48, 21, 80, 44, () -> {
            ...
            list.add(GeneratorsLang.POWER.translate(MekanismUtils.convertToDisplay(MekanismGeneratorsConfig.generators.windGenerationMin
                  * (tile.getCurrentMultiplier()))));
        ...
        addRenderableWidget(new GuiEnergyTab(this, () -> List.of(GeneratorsLang.PRODUCING_AMOUNT.translate(
                    tile.getActive() ? EnergyDisplay.of(MekanismGeneratorsConfig.generators.windGenerationMin * (tile.getCurrentMultiplier())) : EnergyDisplay.ZERO),
