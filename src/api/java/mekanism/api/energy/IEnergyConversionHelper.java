...
public interface IEnergyConversionHelper {
     ...
     */
    IEnergyConversionHelper INSTANCE = ServiceLoader.load(IEnergyConversionHelper.class, IEnergyConversionHelper.class.getClassLoader()).findFirst().orElseThrow(() -> new IllegalStateException("No valid ServiceImpl for IEnergyConversionHelper found"));
